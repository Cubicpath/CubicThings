 ...
 * {@link com.cubicpath.cubicthings.core.init.ContainerInit} - Contains the deferred register and fields for custom {@linkplain net.minecraft.inventory.container.ContainerType Container}s<br>
